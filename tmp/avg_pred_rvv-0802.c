...
if(width > 8){
    ...
    do {
        ...
        const vuint8m1_t vvp = __riscv_vle8_v_u8m1(pred, vl);
        vuint8m1_t vvr;

        uint16_t data[] = {1234,5678,9011,1020};

        // size_t vll = __riscv_vsetvl_e8m1(16);
        vuint16m1_t v16 = __riscv_vle16_v_u16m1(data, 4);
        vuint32m1_t v32 = __riscv_vle32_v_u32m1(data, 2);
        vvr = __riscv_vreinterpret_v_u32m1_u8m1(v32);
        vvr = __riscv_vreinterpret_v_u16m1_u8m1(v16);
